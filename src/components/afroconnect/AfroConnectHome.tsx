...
const AfroConnectHome: React.FC = () => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <header className="bg-gradient-to-r from-[#8B4513] to-[#F5DEB3] text-white shadow-md">
        <div className="container mx-auto px-4 py-3">
          <div className="flex justify-between items-center">
            ...
            <nav className="hidden md:flex space-x-4">
              ...
              <button className="px-3 py-2 rounded-full text-sm bg-white hover:bg-opacity-90 text-[#8B4513] transition-all">
                Become a Vendor
              </button>
            </nav>
      ...
      <footer className="bg-[#8B4513] text-white py-6">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white shadow-lg border-t border-gray-200 flex justify-around py-2 md:hidden">
        <button 
          className={`p-2 rounded-full flex flex-col items-center ${activeTab === 'home' ? 'text-[#8B4513]' : 'text-gray-500'}`}
        ...
        <button 
          className={`p-2 rounded-full flex flex-col items-center ${activeTab === 'marketplace' ? 'text-[#8B4513]' : 'text-gray-500'}`}
        ...
        <button 
          className={`p-2 rounded-full flex flex-col items-center ${activeTab === 'vendors' ? 'text-[#8B4513]' : 'text-gray-500'}`}
        ...
        <button 
          className={`p-2 rounded-full flex flex-col items-center ${activeTab === 'culture' ? 'text-[#8B4513]' : 'text-gray-500'}`}
        ...
        <button 
          className={`p-2 rounded-full flex flex-col items-center ${activeTab === 'profile' ? 'text-[#8B4513]' : 'text-gray-500'}`}
